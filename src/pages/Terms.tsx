		...
		<div className="w-full overflow-hidden py-[10rem]">
			<div className="font-satoshi font-light text-md lg:text-xl w-[95%] xl:w-[60%] mx-auto border-x-2 p-1 md:p-10 h-full">
				...
				<p className="py-5 ml-5">
					...
					explains the terms by which you may use our online and/or
					mobile services, website, and software provided on or in
					...
					Agreement ("Agreement") and to the collection and use of
					your information as set forth in the Go-Eazy Privacy Policy,
					whether or not you are a registered user of our Services.
					Users of our Service must also agree to our Acceptable Use
					Policy. Go-Eazy reserves the right to make unilateral
					modifications to these terms and will provide notice of
					these changes as described below. This Agreement applies to
				...
				<p className="py-5 ml-5">
					...
					do not agree, you may not use the Services. You may use the
					Services only if you can form a binding contract with
					Go-Eazy, and only in compliance with this Agreement and all
					applicable local, state, national, and international laws,
					rules and regulations.{" "}
				</p>
				<p className="py-5 ml-5">
					You must be of at least the age of 18, or accessing the
					Services under the supervision of a parent or a legal
					guardian, under which the Guardian would be held liable for
					your actions, to use the Services of Go-Eazy, In Certain
					instances, Go-Eazy may require you to provide proof of
					identity to create your account, or to access or use the
					Services, and you acknowledge and agree that you may be
					denied access or use of the Services if you refuse to
					provide such proof. The Services are not available to any
					Users previously removed from the Services by Go-Eazy.{" "}
				</p>
				...
				<p className="py-5 ml-5">
					...
					non-transferable, freely revocable license to use the
					Services for your personal, non-commercial use only and as
					permitted by the features of the Services. Go-Eazyreserves
					all rights not expressly granted herein in the Services and
					the Go-Eazy Content (as defined below). Go-Eazy may
				...
				<p className="py-5 ml-5">
					...
					to time and in our sole discretion. We may maintain
					different types of accounts for different types of Users. If
					you open an Go-Eazy account on behalf of a company,
					organization, or other entity, then (a) "you" includes you
					and that entity, and (b) you represent and warrant that you
					are an authorized representative of the entity with the
					authority to bind the entity to this Agreement and that you
					agree to this Agreement on the entity's behalf. By
					connecting to Go-Eazy with a third-party service, you give
					us permission to access and use your information from that
					service as permitted by that service, and to store your
					log-in credentials for that service. You may never use
					another User's account without permission. When creating
					your account, you must provide accurate and complete
					information, and you must keep this information up to date.
					Your failure to maintain accurate, complete, and up-to-date
					Account information may result in your inability to access
					and use the Services or our termination of this Agreement.
				</p>
				<p className="py-5 ml-5">
					You are solely responsible for the activity that occurs on
					your account, and you must keep and maintain account
					security and confidentiality. You must notify Go-Eazy
					immediately of any breach of security or unauthorized use of
					your account. Go-Eazy will not be liable for any losses
					caused by any unauthorized use of your account.
				</p>
				<p className="py-5 ml-5">
					By providing Go-Eazy your email address you consent to our
				...
				<p className="py-5 ml-5">
					...
					access the Services (except that Go-Eazy grants the
					operators of public search engines revocable permission to
					use spiders to copy publicly available materials from for
					...
					email, SMS, or other messages; (iv) attempting to interfere
					...
					agents through the Services; (vii) collecting or harvesting
					any personally identifiable information, including account
					names, from the Services; (viii) using the Services for any
					commercial solicitation purposes; (ix) impersonating another
					person or otherwise misrepresenting your affiliation with a
					person or entity, conducting fraud, hiding or attempting to
					hide your identity; (x) interfering with the proper working
					of the Services; (xi) accessing any content on the Services
					through any technology or means other than those provided or
					authorized by the Services; or (xii) bypassing the measures
				...
				<p className="py-5 ml-5">
					We may, without prior notice, change the Services; stop
					providing the Services or features of the Services, to you
					or to Users generally; or create usage limits for the
					Services. We may permanently or temporarily terminate or
					suspend your access to the Services or refuse to provide a
					Service or a particular order, without notice and liability
					for any reason, including if in our sole determination you
					violate any provision of this Agreement, or for no reason.
					Upon termination for any reason or no reason, you continue
					to be bound by this Agreement.
				</p>
				<p className="py-5 ml-5">
					You are solely responsible for your interactions with other
					Users. We reserve the right, but have no obligation, to
					monitor disputes between you and other Users. Go-Eazy shall
				...
				<p className="py-5 ml-5">
					...
					service marks, copyrights, photographs, audio, videos, and
					music (the " Go-Eazy Content"), and all Intellectual
					Property Rights related thereto, are the exclusive property
					of Go-Eazy and its licensors. Except as explicitly provided
					herein, nothing in this Agreement shall be deemed to create
					a license in or under any such Intellectual Property Rights,
					and you agree not to sell, license, rent, modify,
					distribute, copy, reproduce, transmit, publicly display,
					publicly perform, publish, adapt, edit or create derivative
					works from any Go-Eazy Content. Use of the Go-Eazy Content
					for any purpose not expressly permitted by this Agreement is
					strictly prohibited.
				</p>
				<p className="py-5 ml-5">
					You may choose to or we may invite you to submit comments or
					ideas about the Services, including without limitation about
					how to improve the Services or our products ("Ideas"). By
					submitting any Idea, you agree that your disclosure is
					gratuitous, unsolicited and without restriction and will not
					place Go-Eazy under any fiduciary or other obligation and
					...
					acknowledge that, by acceptance of your submission, does not
				...
				<p className="py-5 ml-5">
					...
					services, at any time in its sole discretion. Any change to
					our pricing or payment terms shall become effective
					immediately as provided in this Agreement. Any acceptance of
					billing through any used messaging platform will be
					considered as a final confirmation of acceptance and legally
				...
				<p className="py-5 ml-5">
					...
					only Go-Eazy sole discretion. Any refunds will be made onto
					the original mode of payment. In the event that Go-Eazy
					suspends or terminates your account or this Agreement, you
					understand and agree that you shall receive no refund or
					exchange for any Go-Eazy Property, any content or data
					associated with your account, or for anything else, except
					if, in Go-Eazy sole discretion, Go-Eazy provides you a
					refund or exchange.
				</p>
				<p className="py-5 ml-5">
					You have the right to cancel an order within 24 hours unless
					the order has been executed, execution stage is when the
					agreed transaction amount is debited from your credit card.
					Go-Eazy can cancel any order and you will be notified
					accordingly. Any payment made prior to an order being
					canceled by Go-Eazy will usually be reimbursed using the
					same method you used to pay for. Any order canceled after it
					becomes Un-cancellable will be charged to you. Go-Eazyalone
					will determine whether an order is Un-cancellable or not.
					For example, if a customer orders food delivery, and decides
					to cancel the order when the order has almost arrived,
					Go-Eazy will not reward a refund. You agree that your
				...
				<p className="py-5 ml-5">
					...
					interaction with the Services must be accurate, complete,
					and current. You agree to pay all charges incurred by users
					of your credit card, debit card, or other payment method
					used in connection with a purchase or transaction or other
					monetary transaction interaction with the Services at the
					prices in effect when such charges are incurred. You will
				...
				<p className="py-5 ml-5">
					A single order may be split into multiple shipments,
					depending on the availability of the item and/or weight
					limits for a parcel by the courier/postal company. The
					cardholder should be aware of the possibility that multiple
					shipments may result in multiple postings to the
					cardholder's monthly statement.
				</p>
				<p className="py-5 ml-5">
					Delivery Fees will be covered in the item price and delivery
					time will be the same day{" "}
				</p>
				<p className="py-5 ml-5">
				...
				<p className="py-5 ml-5">
					...
					services. If you access a third-party website or service
					from the Services, you do so at your own risk, and you
					understand that this Agreement and Go-Eazy Privacy Policy do
					not apply to your use of such sites. You expressly relieve
					Go-Eazy from any and all liability arising from your use of
					any third-party website, service, or content. Additionally,
					your dealings with or participation in promotions of
					advertisers found on the Services, including payment and
					delivery of goods, and any other terms (such as warranties)
					are solely between you and such advertisers. You agree that
				...
				<p className="py-5 ml-5">
					...
					agents, officers, and directors, from and against any and
					...
					received by you; (ii) your violation of any term of this
					Agreement, including without limitation your breach of any
					of the representations and warranties above; (iii) your
					violation of any third-party right, including without
					limitation any right of privacy, Intellectual Property
					Rights, and any rights of Third Party Providers; (iv) your
				...
				<p className="py-5 ml-5">
					...
					written, obtained by you from Go-Eazy or through the service
					will create any warranty not expressly stated herein.
					Without limiting the foregoing, Go-Eazy, its subsidiaries,
					its affiliates, and its licensors do not warrant that the
					...
					that any requests will be met satisfactorily or at all; or
					that the service is free of viruses or other harmful
					components. Any content downloaded or otherwise obtained
					through the use of the service is downloaded at your own
					risk and you will be solely responsible for any damage to
					your computer system or mobile device or loss of data that
					results from such download or your use of the service.
				</p>
				<p className="py-5 ml-5">
					Go-Eazy does not guarantee the suitability, safety, or
					ability of any third party provider, nor that any such third
					party provider will meet your requirements or expectations.
					Go-Eazy does not warrant, endorse, guarantee, or assume
					responsibility for any product or service advertised or
					offered by a third party through the Go-Eazy service or any
					hyperlinked website or service, and Go-Eazy will not be a
					party to or in any way monitor any transaction between you
					and providers of such third party products or services.
				</p>
				<p className="py-5 ml-5">
					Federal law, some provinces and other jurisdictions do not
				...
				<p className="py-5 ml-5">
					...
					inability to use, this service. Under no circumstances will
					Go-Eazy be responsible for any damage, loss or injury
					resulting from hacking, tampering or other unauthorized
					access or use of the service or your account or the
					information contained therein.
				</p>
				<p className="py-5 ml-5">
					To the maximum extent permitted by applicable law, Go-Eazy
					assumes no liability or responsibility for any (i) errors,
					mistakes, or inaccuracies of requests or content; (ii)
					...
					omissions in any requests or content or for any loss or
					damage incurred as a result of the use of any content
					posted, emailed, transmitted, or otherwise made available
					through the service; (vii) the defamatory, offensive, or
					illegal conduct of any third party; and/or (viii) any
					transaction or relationship between you and any third-party
					provider. In no event shall go-Eazy, its affiliates, agents,
					directors, employees, suppliers, or licensors be liable to
					you for any claims, proceedings, liabilities, obligations,
					damages, losses or costs in any amount.
				</p>
				<p className="py-5 ml-5">
					This limitation of liability section applies whether the
					alleged liability is based on contract, tort, negligence,
					strict liability, or any other basis, even if Go-Eazy has
				...
				<p className="py-5 ml-5">
					If you are dissatisfied with the Service, your sole
					exclusive remedy is to discontinue your use of it. Further,
					you agree that any unauthorized use of the Services as a
					result of your negligent act or omission would result in
					irreparable injury to go-Eazy. Go-Eazy shall treat any such
				...
				<p className="py-5 ml-5">
					...
					Go-Eazy is not and cannot be a party to or control in any
					manner any transaction between the user and the third-party
					provider and cannot guarantee that a buyer or seller will
					complete a transaction or accept the return of an item or
					provide any refund for the same. You will not hold Go-Eazy
					responsible for other users' or third-party provider’s
					content, actions, or inactions, or items or Information.
				...
				<p className="py-5 ml-5">
					...
					expiry or cancellation of this User Agreement for any
					reason. Go-Eazy will NOT deal or provide any services or
				...
				<p className="py-5 ml-5">
					...
					arises out of or in connection with or in relation to this
					User Agreement, including (without limitation) any question
					regarding the formation, existence, scope, performance,
					interpretation, validity or termination of this User
					Agreement or this clause, or any question regarding the
					legal relationships established by this User Agreement or
					the consequences of its nullity, then the parties shall
					first attempt amicably to settle the dispute through
					good-faith negotiations over a period of thirty (60)
					calendar days commencing on the date that a party first
					sends to the other party written notice of the Dispute.
				</p>
				<p className="py-5 ml-5">
					In the event that a Dispute has not been settled amicably by
					the relevant parties by the end of such thirty (30) calendar
					day period, the parties hereby agree that the Dispute shall
					be referred to and finally resolved by binding arbitration
					as set out below, under the Arbitration Rules of the Dubai
					International Financial Centre - London Court of
					International Arbitration ("LCIA"), which rules ("Rules")
					are deemed to be incorporated by reference into this clause.
					The number of arbitrators shall be one. The parties to the
					arbitration shall seek to agree on a sole arbitrator to be
					nominated to the LCIA court for appointment. If the parties
					to the arbitration fail to nominate a sole arbitrator within
					30 days from the date of the service of the request upon the
					respondent (or such greater or lesser period as may be fixed
					by the LCIA Court), the sole arbitrator shall be appointed
					by the LCIA Court. The seat or legal place of the
					arbitration shall be Dubai International Financial Centre,
					UAE. The arbitration proceedings shall be conducted in the
					English language and the award shall be in English. The
					foregoing provisions of this clause are without prejudice to
					the right of Go-Eazy to seek interim relief at any time from
					any court of competent jurisdiction (whether or not an
					arbitrator has been appointed) and Go-Eazy shall not be
				...
				<p className="py-5 ml-5">
					...
					be assigned by Go-Eazy without restriction. Any attempted
				...
				<p className="py-5 ml-5">
					...
					notice on our website, as determined by Go-Eazy in our sole
					discretion. Go-Eazy reserves the right to determine the form
					and means of providing notifications to our Users. Go-Eazy
					is not responsible for any automatic filtering you or your
					network provider may apply to email notifications we send to
					the email address you provide us. Go-Eazy may, in its sole
					discretion, modify or update this Agreement from time to
					time, and so you should review this page periodically. When
					we change the Agreement in a material manner, we will update
					the ‘last modified' date at the bottom of this page. Your
					continued use of the Services after any such change
					constitutes your acceptance of the new Terms of Use. If you
					do not agree to any of these terms or any future Terms of
				...
				<p className="py-5 ml-5">
					...
					agreement between you and Go-Eazy concerning the Services.
				...
				<p className="py-5 ml-5">
					...
					and Go-Eazy failure to assert any right or provision under
				...
				<p className="py-5 ml-5">
					...
					last modified on (Date of modification).
				</p>
			</div>
		</div>
	);
