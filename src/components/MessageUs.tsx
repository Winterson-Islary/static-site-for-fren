	...
	return (
		...
		>
			<div className="w-full flex">
				<div className="bg-[#cc3115] flex items-center w-[200px] md:w-[250px] rounded-sm p-2 justify-center gap-2 hover:bg-black  hover:cursor-pointer  duration-500 ease-in-out select-none">
